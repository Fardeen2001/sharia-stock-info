...
{/*       <Script id="grocliq_fix" strategy="afterInteractive">
        ...
        <script defer id="grocliq_fix" src="https://grocliqfixissues.azurewebsites.net/technicalIssues/generate-dynamic-fix-script?userId=677e2bc20dd7d8bec8fe9427"></script>
        <meta
